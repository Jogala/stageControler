...
long 	PI_FUNC_DECL	PI_ConnectRS232(const long nPortNr, const long nBaudRate);
#ifndef WIN32
...
BOOL PI_FUNC_DECL PI_qSPA_String(int ID, const char* szAxes, unsigned int* iParameterArray, char* szStrings, int iMaxNameSize);
...
BOOL PI_FUNC_DECL PI_STE(int iId, const char* szAxes, const double* dOffsetArray);
BOOL PI_FUNC_DECL PI_qSTE(int iId, const char* szAxes, double* pdValueArray);
BOOL PI_FUNC_DECL PI_IMP(int iId, const char*  szAxes, const double* pdImpulseSize);
BOOL PI_FUNC_DECL PI_IMP_PulseWidth(int iId, char cAxis, double dOffset, int iPulseWidth);
BOOL PI_FUNC_DECL PI_qIMP(int iId, const char* szAxes, double* pdValueArray);
...
BOOL PI_FUNC_DECL PI_DIO(long ID, const int* piChannelsArray, const BOOL* pbValueArray, int iArraySize);
BOOL PI_FUNC_DECL PI_qDIO(long ID, const int* piChannelsArray, BOOL* pbValueArray, int iArraySize);
...
BOOL PI_FUNC_DECL PI_qWTR(long ID, const int* piWaveGeneratorIdsArray, int* piTableRateArray, int* piInterpolationTypeArray, int iArraySize);
...
BOOL PI_FUNC_DECL PI_ONL(long ID, const int* iPiezoCannels, const int* pdValueArray, int iArraySize);
BOOL PI_FUNC_DECL PI_qONL(long ID, const int* iPiezoCannels, int* pdValueArray, int iArraySize);
...
/////////////////////////////////////////////////////////////////////////////
// Spezial
BOOL	PI_FUNC_DECL	PI_GetSupportedFunctions(long ID, long* piComandLevelArray, const int iiBufferSize, char* szFunctionNames, const int iMaxFunctioNamesLength);
BOOL	PI_FUNC_DECL	PI_GetSupportedParameters(long ID, int* piParameterIdArray, int* piComandLevelArray, int* piMennoryLocationArray, int* piDataTypeArray, int* piNumberOfItems, const int iiBufferSize, char* szParameterName, const int iMaxParameterNameSize);
